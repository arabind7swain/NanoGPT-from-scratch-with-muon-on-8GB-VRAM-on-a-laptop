...
def process_shard(args):
    ...
    filename = os.path.join(OUTPUT_DIR, f"climbmix_train_{shard_idx:06d}.bin")
...
def prepare():
    ...
    os.rename(
        os.path.join(OUTPUT_DIR, f"climbmix_train_{-1:06d}.bin"),
        os.path.join(OUTPUT_DIR, "climbmix_val_000000.bin")
    )
